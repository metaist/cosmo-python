...
<p align="center">
  <a href="https://github.com/metaist/cosmo-python/actions/workflows/ci.yaml"><img alt="Build" src="https://img.shields.io/github/actions/workflow/status/metaist/cosmo-python/.github/workflows/ci.yaml?branch=main&logo=github"/></a>
  <a href="https://github.com/metaist/cosmo-python/releases/latest"><img alt="Release" src="https://img.shields.io/github/v/release/metaist/cosmo-python?logo=github"/></a>
  <a href="https://docs.metaist.com/cosmo-python/"><img alt="Docs" src="https://img.shields.io/badge/docs-docs.metaist.com-blue"/></a>
</p>
...
📖 **[Read the full documentation](https://docs.metaist.com/cosmo-python/)**

- [Supply Chain](https://docs.metaist.com/cosmo-python/supply-chain/) — Upstream dependencies, GitHub Actions, verification
- [Releases](https://docs.metaist.com/cosmo-python/releases/) — Release process, manifest format, verification
- [Building](https://docs.metaist.com/cosmo-python/building/) — Local build instructions
- [Limitations](https://docs.metaist.com/cosmo-python/limitations/) — Known differences from standard CPython
- [Contributing](CONTRIBUTING.md) — Development setup, making releases
